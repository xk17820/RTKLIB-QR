...
def parser():
    ...
    t.add_argument('--evidence-threshold',type=float,default=2.)
    t.add_argument('--evidence-width',type=float,default=4.)
    t.add_argument('--compact',action='store_true')
    t.add_argument('--guard-anchor',type=float,default=40.)
    t.add_argument('--guard-width',type=float,default=10.)
    t.add_argument('--phase-guard-cap',type=float,default=None,help='fixed phase guard, default 1 or inherited')
    t.add_argument('--selection',choices=['rtk-safe','float'],default='rtk-safe')
    t.add_argument('--selection-min-improvement',type=float,default=.01)
    t.add_argument('--selection-fix-threshold',type=float,default=.1)
